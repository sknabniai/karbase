...
namespace Sungero.RecordManagement.Server
{
  public partial class ModuleInitializer
  {
    ...
    {
      InitializationLogger.Debug("Init: Grant rights on documents to registration incoming doсument role.");
    ...
    {
      InitializationLogger.Debug("Init: Grant rights on documents to registration outgoing doсument role.");
