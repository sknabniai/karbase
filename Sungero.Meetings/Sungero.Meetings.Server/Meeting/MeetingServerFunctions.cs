...
namespace Sungero.Meetings.Server
{
  partial class MeetingFunctions
  {
    ...
    public virtual string GetMeetingMembersString(bool onlyMembers, bool withJobTitle)
    {
      ...
      var employees = Docflow.PublicFunctions.Module.Remote.GetEmployeesFromRecipientsRemote(members);
    ...
    {
      var employees = Docflow.PublicFunctions.Module.Remote.GetEmployeesFromRecipientsRemote(new List<IRecipient> { recipient });
