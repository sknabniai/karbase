...
namespace Sungero.Docflow.Client
{
  partial class ApprovalReviewAssignmentActions
  {
    ...
    public virtual void Informed(Sungero.Workflow.Client.ExecuteResultActionArgs e)
    {
      ...
      // Подписать ЭП.
      Functions.ApprovalReviewAssignment.SetSignature(_obj, e, ApprovalReviewAssignments.Resources.Informed);
    }
    ...
    public virtual void AddActionItem(Sungero.Workflow.Client.ExecuteResultActionArgs e)
    {
      ...
      // Подписать ЭП.
      Functions.ApprovalReviewAssignment.SetSignature(_obj, e, ApprovalReviewAssignments.Resources.SentForExecution);
    }
