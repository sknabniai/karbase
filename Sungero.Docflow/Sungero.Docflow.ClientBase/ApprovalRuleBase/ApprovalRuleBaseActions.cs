...
namespace Sungero.Docflow.Client
{
  ...
  partial class ApprovalRuleBaseActions
  {
    ...
    {
      return !_obj.State.IsInserted && _obj.Status != Status.Closed && _obj.AccessRights.CanUpdate() && !Functions.Module.IsLockedByOther(_obj);
    }
    ...
    {
      return _obj.Status == Status.Draft && _obj.AccessRights.CanUpdate() && !Functions.Module.IsLockedByOther(_obj);
    }
