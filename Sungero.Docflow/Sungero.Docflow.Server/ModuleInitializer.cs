  ...
  public partial class ModuleInitializer
  {
    public override void Initializing(Sungero.Domain.ModuleInitializingEventArgs e)
    {
      ...
      if (allUsers != null)
      {
        ...
        Reports.AccessRights.Grant(Reports.GetAssignmentCompletionReport().Info, allUsers, DefaultReportAccessRightsTypes.Execute);
      ...
      InitializationLogger.Debug("Init: Grant right on endorsment operation to signing role.");
    ...
    public static void GrantRightsOnDatabooks(IRole allUsers)
    {
      ...
      Docflow.ApprovalStages.AccessRights.Grant(allUsers, DefaultAccessRightsTypes.Read);
      ...
      Docflow.ApprovalStages.AccessRights.Save();
    ...
    public static void GrantRightsOnDocuments(IRole allUsers)
    {
      ...
      Docflow.DocumentTemplates.AccessRights.Grant(allUsers, DefaultAccessRightsTypes.Read);
      ...
      Docflow.DocumentTemplates.AccessRights.Save();
    }
    ...
    public static void CreateFileTypesAndAssociatedApps()
    {
      ...
      CreateAssociatedApp("exe", Resources.Initialize_FileTypes_Other_exe, AppMonitoringType.ByProcessAndWindow, fileType);
      ...
      CreateAssociatedApp("msi", Resources.Initialize_FileTypes_Other_msi, AppMonitoringType.Process, fileType);
    ...
    {
      InitializationLogger.Debug("Init: Create default agreement rules.");
      ...
      var rule = CreateDefaultRule(Resources.DefaultApprovalRuleNameOutgoing,
                                   Sungero.Docflow.ApprovalRuleBase.DocumentFlow.Outgoing, stages);
      ...
      if (rule != null)
      {
        ...
        condition.Save();
        var sendStageNumber = stages.IndexOf(StageType.Print) + 1;
        AddConditionToRule(rule, condition, sendStageNumber);
        ...
        AddConditionToRule(rule, rolesCompareCondition, managerStageNumber);
      }
      
      stages = new List<Enumeration>
      { StageType.Manager, StageType.Approvers, StageType.Print, StageType.Sign, StageType.Register, StageType.Notice };
      var internalRule = CreateDefaultRule(Resources.DefaultApprovalRuleNameInternal, Sungero.Docflow.ApprovalRuleBase.DocumentFlow.Inner, stages);
    ...
    public static void SetRuleStages(IApprovalRuleBase rule, List<Enumeration> stages)
    {
      ...
      foreach (var stage in stages)
        rule.Stages.AddNew().Stage = alreadyExistStages.FirstOrDefault(s => s.StageType == stage) ??
          ApprovalStages.GetAll(s => s.StageType == stage).FirstOrDefault() ??
    ...
    public static void CreateReportsTables()
    {
      ...
      var assignmentCompletionReportTableName = Constants.AssignmentCompletionReport.SourceTableName;
      ...
      Docflow.PublicFunctions.Module.DropReportTempTables(new[] {
                                                            ...
                                                            skippedIndexes,
                                                            availableDocs,
                                                            assignmentCompletionReportTableName,
      ...
      Functions.Module.ExecuteSQLCommandFormat(Queries.AssignmentCompletionReport.CreateSourceTable, new[] { assignmentCompletionReportTableName });
