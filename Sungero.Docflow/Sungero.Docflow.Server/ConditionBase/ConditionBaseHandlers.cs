...
namespace Sungero.Docflow
{
  ...
  partial class ConditionBaseApprovalRoleForComparisonPropertyFilteringServerHandler<T>
  {
    ...
    {
      return query.Where(r => r.Type != Docflow.ApprovalRoleBase.Type.Approvers && !Equals(r, _obj.ApprovalRole));
    }
  }
  ...
  partial class ConditionBaseApprovalRolePropertyFilteringServerHandler<T>
  {
    ...
    {
      return query.Where(r => r.Type != Docflow.ApprovalRoleBase.Type.Approvers && !Equals(r, _obj.ApprovalRoleForComparison));
    }
  }
