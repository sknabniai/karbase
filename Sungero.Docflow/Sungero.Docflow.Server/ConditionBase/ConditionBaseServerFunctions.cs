...
namespace Sungero.Docflow.Server
{
  partial class ConditionBaseFunctions
  {
    ...
    public virtual Structures.ConditionBase.ConditionResult CompareRoles(IApprovalTask task)
    {
      ...
      var employeeForComparsion = Functions.ApprovalRoleBase.GetRolePerformer(_obj.ApprovalRoleForComparison, task);
      if (employee == null && employeeForComparsion == null)
        return Structures.ConditionBase.ConditionResult.Create(null, ConditionBases.Resources.CannotComputeRolesFormat(_obj.Name));
      return Structures.ConditionBase.ConditionResult.Create(Equals(employee, employeeForComparsion), string.Empty);
    }
    ...
    {
      var employee = Functions.ApprovalRoleBase.GetRolePerformer(_obj.ApprovalRole, task);
      var employeeForComparsion = Functions.ApprovalRuleBase.GetEmployeeByAssignee(_obj.RecipientForComparison);
      return Structures.ConditionBase.ConditionResult.Create(Equals(employee, employeeForComparsion), string.Empty);
    }
