...
namespace Sungero.Docflow
{
  ...
  partial class OfficialDocumentServerHandlers
  {
    ...
    public override void BeforeDelete(Sungero.Domain.BeforeDeleteEventArgs e)
    {
      ...
      var canDelete = Functions.OfficialDocument.CheckDeleteEntityRights(_obj);
    ...
    public override void BeforeSave(Sungero.Domain.BeforeSaveEventArgs e)
    {
      ...
      bool isDeadlineExtentsionTaskCallContext;
      isDeadlineExtentsionTaskCallContext = e.Params.TryGetValue(Docflow.Constants.Module.DeadlineExtentsionTaskCallContext, out isDeadlineExtentsionTaskCallContext) ?
        isDeadlineExtentsionTaskCallContext : false;
      if (!isDeadlineExtentsionTaskCallContext)
      {
