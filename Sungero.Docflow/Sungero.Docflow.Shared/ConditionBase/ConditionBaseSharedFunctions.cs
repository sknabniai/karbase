...
namespace Sungero.Docflow.Shared
{
  partial class ConditionBaseFunctions
  {
    ...
    public virtual void ChangePropertiesAccess()
    {
      ...
      _obj.State.Properties.ApprovalRole.IsVisible = isRolesComparer || isRoleEmpComparer;
      _obj.State.Properties.ApprovalRole.IsRequired = isRolesComparer || isRoleEmpComparer;
      ...
      _obj.State.Properties.RecipientForComparison.IsVisible = isRoleEmpComparer;
      _obj.State.Properties.RecipientForComparison.IsRequired = isRoleEmpComparer;
