...
namespace Sungero.Docflow
{
  partial class ApprovalExecutionAssignmentSharedHandlers
  {
    ...
    public virtual void ExchangeServiceChanged(Sungero.Docflow.Shared.ApprovalExecutionAssignmentExchangeServiceChangedEventArgs e)
    {
    ...
    public virtual void DeliveryMethodChanged(Sungero.Docflow.Shared.ApprovalExecutionAssignmentDeliveryMethodChangedEventArgs e)
    {
      var document = _obj.DocumentGroup.OfficialDocuments.FirstOrDefault();
      var isManyAddressees = OutgoingDocumentBases.Is(document) ? OutgoingDocumentBases.As(document).IsManyAddressees.Value : false;
