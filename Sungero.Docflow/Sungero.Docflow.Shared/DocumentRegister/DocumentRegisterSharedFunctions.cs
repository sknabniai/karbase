...
namespace Sungero.Docflow.Shared
{
  partial class DocumentRegisterFunctions
  {
    ...
    public int GetCurrentMonth(DateTime registrationDate)
    {
      ...
      return _obj.NumberingPeriod == Docflow.DocumentRegister.NumberingPeriod.Month ? registrationDate.Month : 0;
    }
    ...
    {
      return _obj.NumberingPeriod == Docflow.DocumentRegister.NumberingPeriod.Month ||
